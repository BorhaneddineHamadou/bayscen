...
class ScenarioRunner(object):
    ...
    def __init__(self, args):
        ...
        # --- START MODIFICATION ---
        # Retrieve the logging parameters from args, or use defaults if they are not passed
        # Ensure your argparse setup actually includes these flags (e.g. --test_method, --run_number)
    ...
    def _run_scenarios(self):
        ...
        for config in scenario_configurations:
            ...
            for _ in range(self._args.repetitions):  #  put 2 in this and it repeated from 00! # lets see what happens in reptitions
                ...
                file_path = 'outputs/bayesian_network_manips/scenario2/test/weather_states.json'
...
# SituationGeneration Engine!
    ...
    def select_conflictpoint_syncarrival_loc(self, conflict_point="c1"):
        ...
        file_path = 'outputs/bayesian_network_manips/scenario2/test/conflic_points.json'
...
class EgoVehicle:
    ...
    def select_ego_start_loc(self, start_location_string="base"):
        ...
        file_path = 'outputs/bayesian_network_manips/scenario2/test/ego_start_locations.json'
    ...
    def select_ego_endconditiontrigger_loc(self, ego_goal_location="base"):  # THE GOAL LOCATION OF EGO 
        ...
        file_path = 'outputs/bayesian_network_manips/scenario2/test/ego_goal_locations.json'
...
class OtherVehicle:
    ...
    def select_other_vehicle_start_loc(self, start_location_string="base"):
        ...
        file_path = 'outputs/bayesian_network_manips/scenario2/test/other_start_locations.json'
    ...
    def select_other_vehicle_stopothertrigger_loc(self, other_vehicle_goal_location="base"):  # THE GOAL LOCATION OF Other vehicle 
        ...
        file_path = 'outputs/bayesian_network_manips/scenario2/test/other_goal_locations.json'
