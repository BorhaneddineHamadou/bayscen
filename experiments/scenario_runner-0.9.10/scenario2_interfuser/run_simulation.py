...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run batch simulations from Excel scenarios (Scenario 2)")
    ...
    print(f"Output Configuration: Method={args.test_method} | Run={args.run_number} | Scenario=2 (Vehicle-Cyclist)")
    ...
    # for index, row in df.iloc[432:].iterrows():
        ...
        # --- FORCE XML TO SCENARIO 2 (Bicycle) ---
