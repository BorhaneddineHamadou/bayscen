    ...
    def get_data(self):
        try: 
            ...
            while len(data_dict.keys()) < len(self._sensors_objects.keys()):
                ...
                # print(f"🔍 Waiting for data from {data_dict.keys()} sensors...")
                ...
                if "speed" not in data_dict.keys() and len(self._sensors_objects.keys()) == len(data_dict.keys()) + 1:
                    # print("Ignoring speed sensor")
                    break
