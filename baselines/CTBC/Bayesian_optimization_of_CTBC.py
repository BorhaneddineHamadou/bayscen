...
constrains=[]
sub_constrains=[]
lines=open('parameters_scenario3.txt').readlines()
length=len(lines)
...
#        plt.savefig('C:\python figure\\black_box_optimization.png', format='png', dpi=600)
    plt.savefig('C:\\Users\\BH280005\\Desktop\\BayScen_ICST\\Baselines\\CTBC\\Figures\\black_box_optimization3.png',dpi=600.0)
    
    plt.margins(0,0)
    plt.savefig('C:\\Users\\BH280005\\Desktop\\BayScen_ICST\\Baselines\\CTBC\\Figures\\black_box_optimization3.svg',format='svg')
    plt.show()
    #plt.gcf().clear()
...
with open('test_scenarios_scenario3.csv', 'w', newline='') as csvfile:
