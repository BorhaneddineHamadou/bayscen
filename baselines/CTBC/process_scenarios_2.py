...
df = pd.read_csv("test_scenarios_scenario2.csv", skiprows=1, header=None)

# Rename columns (first one is PathInteraction now)
df.columns = [
    "Cloudiness", "FogDensity", "FogDistance", "PathInteraction", "Precipitation", "PrecipitationDeposits",
    "RoadFriction", "TimeOfDay", "Wetness", "WindIntensity"
]
...
# Save to Excel
df.to_excel("processed_test_scenarios_scenario2.xlsx", index=False)

print("Excel file 'processed_test_scenarios_scenario2.xlsx' created successfully!")
